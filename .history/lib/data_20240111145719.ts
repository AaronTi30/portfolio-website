...
export const projectsData = [
  ...
  },
  {
    title: "ai-pathology",
    description:
      "Researched and created custom convolutional neural network and leveraged transfer learning using popular pre-trained machine learning model architectures",
