...
export const projectsData = [
  ...
  },
  {
    title: "ai-pathology",
    description:
      "Researched and created custom convolutional neural network and leveraged transfer learning utilizing pre-trained machine learning models to classify breast cancer tissue as benign or malignant. ",
